...
void buildHuffmanTree(string text)
{
    ...
    cout << "||          Таблица встречаемости символов в тексте            ||\n";
    ...
    cout << "_________________________________________________________________\n";
    cout << "|| Таблица соответствия символа и кодовой последовательности   ||\n";
    cout << "||_____________________________________________________________||\n";
    ...
    cout << "||      Выходную последовательность            ||\n";
...
int main()
{
    ...
    cout << "|| Введите пожалуйста строку, которую хотите закодировать ||\n";
